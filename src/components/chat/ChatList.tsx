...
export default function ChatList({
  ...
  if (isLoading && conversations.length === 0) {
    return (
      <div className="bg-white rounded-2xl border border-gray-200 shadow-lg h-full flex flex-col overflow-hidden">
        {/* Header Skeleton */}
        <div className="p-5 border-b border-gray-100 bg-blue-900 flex-shrink-0">
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-lg h-full flex flex-col overflow-hidden">
      ...
      <div className="p-5 border-b border-gray-100 bg-blue-900 flex-shrink-0 sticky top-0 z-10">
        <div className="flex items-center justify-between mb-4">
