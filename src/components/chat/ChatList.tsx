      ...
      <div className="p-4 border-b border-gray-200 bg-white flex-shrink-0 sticky top-0 z-10">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 pl-10 text-sm text-gray-900 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent"
          />
          <svg
