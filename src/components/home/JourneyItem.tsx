import { ArrowUpRightIcon, CalendarIcon, LocationIcon } from "@/components/icons";
...
export default function JourneyItem({
    ...
    return (
        <div className="flex items-start gap-4 w-full cursor-pointer hover:bg-gray-50 transition-colors rounded-lg p-2 -m-2">
