...
import { CloseIcon, ArrowLeftSimpleIcon, ArrowRightSimpleIcon, HeartIcon, ChatBubbleIcon } from '@/components/icons';
      ...
      <div className="relative w-full max-w-6xl h-full flex items-center justify-center">
        ...
        {media.length > 1 && (
          <>
            ...
            >
<ArrowLeftSimpleIcon className="w-6 h-6" />
            </button>
            <button
              onClick={goToNext}
            ...
            >
<ArrowRightSimpleIcon className="w-6 h-6" />
            </button>
          </>
        )}
...
<HeartIcon className={`w-5 h-5 ${isLikedByCurrentUser ? 'fill-current' : ''}`} />
                  <span>{likeCount}</span>
                </div>
                <div className="flex items-center space-x-1">
