...
interface OtpVerificationFormV2Props {
  email: string;
  onSuccess?: () => void;
  onResendOtp?: () => void;
}

export default function OtpVerificationFormV2({
  email,
  onSuccess,
  onResendOtp,
}: OtpVerificationFormV2Props) {
  const { verifyOtp, isLoading, error } = useAuthStoreV2();
