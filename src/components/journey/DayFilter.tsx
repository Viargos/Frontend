            ...
            <div className="flex items-center gap-3">
                {days.map((day) => (
                    <div key={day} className="relative flex-shrink-0">
                        <button
                            ...
                            className={`
                flex w-25 px-4 py-1 justify-center items-center gap-2 rounded-2xl shadow-button font-manrope text-base font-semibold leading-6 cursor-pointer
                ${
                    activeDay === day
              ...
              `}
                ...
                {onAddDay && (
                    <button
                        onClick={onAddDay}
                        className="flex w-25 px-4 py-[2px] justify-center items-center gap-2 rounded-2xl shadow-button font-manrope text-base font-semibold leading-6 flex-shrink-0 border-2 border-dashed border-primary-blue text-primary-blue bg-white hover:bg-blue-50 transition-colors whitespace-nowrap cursor-pointer"
                    >
                        + Add Day
                    </button>
                )}
