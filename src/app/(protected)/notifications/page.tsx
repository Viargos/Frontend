    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 dark:border-slate-800 pb-5 mb-6">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors focus:outline-none"
          >
            Mark all as read
          </button>
        )}
      ...
      {notifications.length > 0 ? (
          ...
          {notifications.map((item, index) => (
            <motion.div
              ...
              className={`group flex items-start justify-between gap-4 p-4 rounded-2xl border transition-all duration-300 ${
                item.isUnread
                  ? 'bg-blue-50/50 dark:bg-blue-950/10 border-blue-100 dark:border-blue-900/30 shadow-xs'
            ...
            >
              <div className="flex items-start gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="inline-block text-[11px] text-gray-400 dark:text-slate-500 mt-2">
                    {item.time}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="rounded-full p-2 text-gray-400 dark:text-slate-500 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-600 dark:hover:text-slate-300 transition-all"
                  type="button"
                >
                  <svg
                    className="h-4 w-4"
                ...
                <button
                  ...
                  className="rounded-full p-2 text-gray-400 dark:text-slate-500 hover:bg-red-50 dark:hover:bg-red-950/20 hover:text-red-600 dark:hover:text-red-400 transition-all"
                  type="button"
                >
        ...
        <div className="text-center py-16 px-4">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500">
