            ...
            >
              <div className="max-w-7xl mx-auto">
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-lg">
                      Discover amazing travel stories from our community of
                      explorers
                    </p>
                  </div>
                ...
                >
                  <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">
                      Experience Our Journey Planning Tools
                    </h2>
                    <p className="text-gray-600 text-lg">
                      See how easy it is to plan your perfect trip with our
                      comprehensive journey creation interface
                    </p>
                  </div>
                      ...
                      <div className="w-full">
                        <div className="bg-white rounded-lg border border-gray-200 p-6">
                          ...
                          <p className="text-gray-600">
                            A magical journey through the City of Light
                          </p>
                ...
                >
                  <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">
                      Visualize Your Travel Routes
                    </h2>
                    <p className="text-gray-600 text-lg">
                      Watch animated paths connect your journey destinations
                    </p>
                  </div>

                  <div className="h-[600px] w-full">
                    <AnimatedRouteDemo className="h-full w-full" />
                  </div>
                </motion.div>
              </div>
            </motion.div>
